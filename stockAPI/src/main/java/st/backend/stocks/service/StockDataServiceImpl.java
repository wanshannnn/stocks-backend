...
public class StockDataServiceImpl implements StockDataService {
    ...
    // 通过 id 获取某个股票在指定时间范围内的所有数据
    @Cacheable(
            value = "dataCache",
            key = "'stock_' + #id + '_data_' + #startTime + '_' + #endTime + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
    public Page<StockDataDTO> getDataByIdAndTimeRange(String id, long startTime, long endTime, Pageable pageable) {
    ...
    // 通过 name 获取某个股票在指定时间范围内的所有数据
    @Cacheable(
            value = "dataCache",
            key = "'stock_' + #name + '_data_' + #startTime + '_' + #endTime + '_' + #pageable.pageNumber + '_' + #pageable.pageSize")
    public Page<StockDataDTO> getDataByNameAndTimeRange(String name, long startTime, long endTime, Pageable pageable) {
